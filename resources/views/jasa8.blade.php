...
<head>
  ...
  <title>Jasa Tukang Pemasangan Pipa</title>
...
<header id="header" class="header d-flex align-items-center fixed-top">
  ...
  <main class="main">
   ...
   <!-- Page Title -->
<div class="page-title dark-background" style="background-image: url(https://png.pngtree.com/thumb_back/fh260/background/20230527/pngtree-white-pipes-arranged-in-a-wall-image_2655921.jpg);">
  <div class="container position-relative">
    <h1 class="sitename">Tukang<span class="highlight">Banten.</span></h1>
    <nav class="breadcrumbs">
      <ol>
        <li><a href="jasa1">JADIMITRA</a></li>
        <li class="current">JASA TUKANG PEMASANGAN PIPA</li>
      </ol>
    </nav>
  </div>
</div><!-- End Page Title -->
  ...
  <div class="container">
    <div class="row position-relative">
      <div class="col-lg-7 about-img" data-aos="zoom-out" data-aos-delay="200">
        <img src="/assets/img/pipa/pipa3.jpg" alt="Gambar Jasa Pemasangan Pipa">
      </div>
      <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
        <h2 class="inner-title">KENAPA HARUS PAKAI JASA KAMI ?</h2>
        <div class="our-story">
          <h3>JASA TUKANG PEMASANGAN PIPA</h3>
          <p>Kami adalah spesialis dalam pemasangan dan perawatan sistem perpipaan. Dengan pengalaman bertahun-tahun, kami menyediakan layanan yang cepat, efisien, dan berkualitas tinggi untuk memastikan sistem perpipaan Anda berfungsi optimal. Baik untuk rumah, kantor, maupun industri, kami siap memberikan solusi terbaik dengan harga terjangkau.</p>
          <ul>
            <li><i class="bi bi-check-circle"></i> <span>"Pemasangan pipa yang rapi, cepat, dan sesuai standar teknis."</span></li>
            <li><i class="bi bi-check-circle"></i> <span>"Layanan perbaikan dan pemeliharaan pipa untuk mencegah kebocoran dan kerusakan."</span></li>
            <li><i class="bi bi-check-circle"></i> <span>"Tim teknisi profesional dengan pengalaman luas dalam instalasi perpipaan."</span></li>
          </ul>
           <!-- 
  ...
  <div class="container">
    <div class="row justify-content-around gy-4">
      ...
      <div id="carouselExample" class="carousel slide col-lg-6" data-bs-ride="carousel" data-aos="fade-up" data-aos-delay="100">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/assets/img/pipa/pipa2.png" class="d-block w-100" alt="Jasa Pemasangan Pipa">
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
        <h3>Solusi Terbaik untuk Pemasangan Pipa Air & Gas</h3>
        <p>Kami menyediakan layanan pemasangan pipa yang profesional dan berkualitas. Dengan tenaga ahli berpengalaman, kami memastikan instalasi pipa yang kuat, tahan lama, dan sesuai standar teknis untuk kebutuhan rumah, industri, maupun proyek komersial.</p>

        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
          <i class="fas fa-toolbox flex-shrink-0"></i>
          <div>
            <h4><a href="" class="stretched-link">Pemasangan Pipa Baru</a></h4>
            <p>Instalasi pipa air dan gas dengan teknik yang tepat untuk menjaga kelancaran distribusi.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
          ...
          <div>
            <h4><a href="" class="stretched-link">Perbaikan & Pemeliharaan Pipa</a></h4>
            <p>Deteksi kebocoran dan perbaikan pipa untuk memastikan aliran tetap lancar tanpa hambatan.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="500">
          ...
          <div>
            <h4><a href="" class="stretched-link">Instalasi Pipa Air Bersih & Kotor</a></h4>
            <p>Solusi lengkap untuk sistem perpipaan rumah tangga, gedung, hingga proyek skala besar.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="600">
          ...
          <div>
            ...
            <p>Tim ahli dengan pengalaman bertahun-tahun dan layanan bergaransi untuk kepuasan pelanggan.</p>
          </div>
        </div>
...
<section class="portfolio section-padding">
    <div class="container">
        <div class="section-title text-center">
            <h2 class="fw-bold">Galeri Layanan Pemasangan Pipa</h2>
            <p class="text-muted">Lihat berbagai proyek pemasangan dan perawatan pipa yang telah kami kerjakan dengan hasil terbaik.</p>
        </div>
        ...
        <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <div class="portfolio-card">
                    <img src="{{ asset('/assets/img/pipa/pipa1.png') }}" class="img-fluid" alt="Pemasangan Pipa Rumah">
                    <div class="portfolio-overlay">
                        <h4>Pemasangan Pipa Rumah</h4>
                        <a href="/assets/img/pipa/pipa1.png" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <div class="portfolio-card">
                    <img src="{{ asset('assets/img/pipa/pipa6.jpg') }}" class="img-fluid" alt="Pemasangan Pipa Kantor">
                    <div class="portfolio-overlay">
                        <h4>Pemasangan Pipa Kantor</h4>
                        <a href="assets/img/pipa/pipa6.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item">
                <div class="portfolio-card">
                    <img src="{{ asset('assets/img/pipa/pipa7.jpg') }}" class="img-fluid" alt="Perawatan Pipa">
                    <div class="portfolio-overlay">
                        <h4>Perawatan Pipa</h4>
                        <a href="assets/img/pipa/pipa7.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<section id="testimonials" class="testimonials section">
    <div class="container section-title" data-aos="fade-up">
        <h2>Testimoni Pelanggan Pemasangan Pipa</h2>
        <p>Pelanggan kami berbagi pengalaman mereka setelah menggunakan layanan pemasangan dan perawatan pipa dari Tukang Banten.</p>
    </div>
                    ...
                    <div class="testimonial-wrap">
                        <div class="testimonial-item">
                            ...
                            <p>
                                ...
                                <span>"Saya sangat puas dengan pemasangan pipa di rumah saya. Tukang Banten bekerja dengan sangat profesional dan rapi."</span>
                ...
                <div class="swiper-slide">
                    <div class="testimonial-wrap">
                        <div class="testimonial-item">
                            ...
                            <p>
                                <i class="bi bi-quote quote-icon-left"></i>
                                <span>"Tim Tukang Banten memberikan solusi terbaik untuk pemasangan pipa di rumah saya. Hasilnya sangat memuaskan."</span>
                                <i class="bi bi-quote quote-icon-right"></i>
                            </p>
                        </div>
                    </div>
