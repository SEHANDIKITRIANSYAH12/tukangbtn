...
<head>
  ...
  <title>Jasa Tukang Angkut</title>
...
<header id="header" class="header d-flex align-items-center fixed-top">
 ...
 <!-- Page Title -->
<div class="page-title dark-background" style="background-image: url(https://d3p0bla3numw14.cloudfront.net/news-content/img/2021/12/08025948/Tips-Memilih-Jasa-Pindahan-Rumah.jpg);">
  <div class="container position-relative">
    <h1 class="sitename">Tukang<span class="highlight">Banten.</span></h1>
    <nav class="breadcrumbs">
      <ol>
        <li><a href="jasa1">JADIMITRA</a></li>
        <li class="current">JASA TUKANG ANGKUT</li>
      </ol>
    </nav>
  </div>
</div><!-- End Page Title -->
  ...
  <div class="container">
    <div class="row position-relative">
      <div class="col-lg-7 about-img" data-aos="zoom-out" data-aos-delay="200">
        <img src="/assets/img/tukangangkut/angkut.png" alt="Gambar Jasa Tukang Angkut">
      </div>
      <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
        <h2 class="inner-title">KENAPA HARUS PAKAI JASA KAMI ?</h2>
        <div class="our-story">
          <h3>JASA PROFESIONAL PENGANGKUTAN BARANG</h3>
          <p>Kami menyediakan layanan angkut barang yang cepat, aman, dan profesional. Dengan tenaga kerja berpengalaman dan peralatan yang memadai, kami siap membantu Anda dalam proses pemindahan barang, baik skala kecil maupun besar.</p>
          <ul>
            <li><i class="bi bi-check-circle"></i> <span>"Layanan angkut barang cepat dan efisien."</span></li>
            <li><i class="bi bi-check-circle"></i> <span>"Tenaga kerja profesional dan berpengalaman."</span></li>
            <li><i class="bi bi-check-circle"></i> <span>"Menjamin keamanan dan ketepatan waktu."</span></li>
          </ul>
  ...
  <div class="container">
    <div class="row justify-content-around gy-4">
      ...
      <div id="carouselExample" class="carousel slide col-lg-6" data-bs-ride="carousel" data-aos="fade-up" data-aos-delay="100">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/assets/img/tukangangkut/angkut1.jpg" class="d-block w-100" alt="Jasa Tukang Angkut">
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
        <h3>Jasa Tukang Angkut Profesional</h3>
        <p>Kami menyediakan layanan angkut barang yang cepat, aman, dan terpercaya. Dengan tenaga kerja berpengalaman dan peralatan yang memadai, kami siap membantu Anda dalam pemindahan barang dengan efisien.</p>

        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
          <i class="fas fa-truck flex-shrink-0"></i>
          <div>
            <h4><a href="" class="stretched-link">Layanan Angkut Barang</a></h4>
            <p>Pindahkan barang dengan cepat dan aman dengan tim profesional kami.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
          ...
          <div>
            <h4><a href="" class="stretched-link">Packing & Pengemasan</a></h4>
            <p>Barang Anda akan dikemas dengan baik untuk memastikan keamanan selama proses pengangkutan.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="500">
          ...
          <div>
            ...
            <p>Kami menjamin ketepatan waktu dalam setiap proses pengiriman dan pemindahan barang.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="600">
          ...
          <div>
            ...
            <p>Keamanan barang adalah prioritas kami, dengan tenaga kerja terpercaya dan profesional.</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="portfolio section-padding">
  <div class="container">
    <div class="section-title text-center">
      <h2 class="fw-bold">Galeri Jasa Angkut</h2>
      <p class="text-muted">Lihat berbagai proyek pengangkutan yang telah kami selesaikan dengan kepuasan pelanggan.</p>
    </div>
    ...
    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="/assets/img/tukangangkut/angkut1.jpg" class="img-fluid" alt="Layanan Angkut Barang">
          <div class="portfolio-overlay">
            <h4>Layanan Angkut Barang</h4>
            <a href="/assets/img/tukangangkut/angkut1.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="/assets/img/tukangangkut/angkut2.jpeg" class="img-fluid" alt="Pindahan Rumah & Kantor">
          <div class="portfolio-overlay">
            <h4>Pindahan Rumah & Kantor</h4>
            <a href="/assets/img/tukangangkut/angkut2.jpeg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="/assets/img/tukangangkut/angkut3.jpg" class="img-fluid" alt="Jasa Logistik">
          <div class="portfolio-overlay">
            <h4>Jasa Logistik</h4>
            <a href="assets/img/tukangangkut/angkut3.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
    </div>
...
<section id="testimonials" class="testimonials section">
  ...
  <div class="container section-title" data-aos="fade-up">
    <h2>Testimoni Pelanggan Jasa Tukang Angkut Tukang Banten</h2>
    <p>Pelanggan kami berbagi pengalaman mereka setelah menggunakan layanan jasa tukang angkut dari Tukang Banten. Kecepatan, kehandalan, dan kepuasan pelanggan adalah prioritas kami.</p>
          ...
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                ...
                <span>"Pelayanan jasa angkut dari Tukang Banten sangat cepat dan profesional. Barang saya sampai dengan aman dan tepat waktu!"</span>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>"Saya sangat terbantu dengan jasa angkut dari Tukang Banten. Pindahan rumah jadi lebih mudah dan tidak merepotkan sama sekali."</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>"Saya menggunakan jasa angkut Tukang Banten untuk mengangkut material ke proyek saya. Sangat cepat dan efisien!"</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>"Butuh jasa angkut barang dalam jumlah besar? Tukang Banten solusinya! Barang sampai dengan aman dan tepat waktu."</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div>
