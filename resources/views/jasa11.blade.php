...
<head>
  ...
  <title>Jasa Tukang Buang Puing Bangunan Atau Proyek</title>
...
<header id="header" class="header d-flex align-items-center fixed-top">
 ...
 <!-- Page Title -->
<div class="page-title dark-background" style="background-image: url(https://cdn.pixabay.com/photo/2015/11/15/18/42/bricks-1044659_960_720.jpg);">
  <div class="container position-relative">
    <h1 class="sitename">Tukang<span class="highlight">Banten.</span></h1>
    <nav class="breadcrumbs">
      <ol>
        <li><a href="jasa1">JADIMITRA</a></li>
        <li class="current">JASA TUKANG BUANG PUING BANGUNAN ATAU PROYEK</li>
      </ol>
    </nav>
  </div>
</div><!-- End Page Title -->
  ...
  <div class="container">
    <div class="row position-relative">
      <div class="col-lg-7 about-img" data-aos="zoom-out" data-aos-delay="200">
        <img src="/assets/img/puing/puing3.jpg" alt="Gambar Jasa Tukang Buang Puing">
      </div>
      <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
        <h2 class="inner-title">KENAPA HARUS PAKAI JASA KAMI ?</h2>
        <div class="our-story">
          <h3>JASA PROFESIONAL PEMBUANGAN PUING BANGUNAN</h3>
          <p>Kami menyediakan layanan pembuangan puing bangunan atau proyek dengan cepat, aman, dan profesional. Dengan tenaga kerja berpengalaman serta armada yang memadai, kami siap membantu Anda membersihkan sisa material konstruksi secara efisien.</p>
          <ul>
            <li><i class="bi bi-check-circle"></i> <span>"Layanan cepat dan efisien dalam membuang puing proyek."</span></li>
            <li><i class="bi bi-check-circle"></i> <span>"Tenaga kerja profesional dan berpengalaman dalam pengangkutan puing."</span></li>
            <li><i class="bi bi-check-circle"></i> <span>"Menjamin kebersihan area proyek setelah pengerjaan."</span></li>
          </ul>
          <!-- 
  ...
  <div class="container">
    <div class="row justify-content-around gy-4">
      ...
      <div id="carouselExample" class="carousel slide col-lg-6" data-bs-ride="carousel" data-aos="fade-up" data-aos-delay="100">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/assets/img/puing/puing4.jpg" class="d-block w-100" alt="Jasa Tukang Buang Puing">
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
        <h3>Jasa Tukang Buang Puing Profesional</h3>
        <p>Kami menawarkan jasa pembuangan puing bangunan atau proyek dengan tenaga kerja yang berpengalaman dan peralatan memadai, memastikan area proyek Anda tetap bersih dan rapi.</p>

        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
          <i class="fas fa-dumpster flex-shrink-0"></i>
          <div>
            <h4><a href="" class="stretched-link">Layanan Buang Puing</a></h4>
            <p>Pembuangan puing secara cepat, aman, dan sesuai prosedur lingkungan.</p>
          </div>
        </div>

        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
          <i class="fas fa-recycle flex-shrink-0"></i>
          <div>
            <h4><a href="" class="stretched-link">Daur Ulang Material</a></h4>
            <p>Kami juga mendukung daur ulang material konstruksi yang masih bisa dimanfaatkan.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="500">
          ...
          <div>
            <h4><a href="" class="stretched-link">Layanan Tepat Waktu</a></h4>
            <p>Kami memastikan jadwal pembuangan puing sesuai dengan kebutuhan proyek Anda.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="600">
          ...
          <div>
            ...
            <p>Proses pembuangan dilakukan dengan standar keamanan yang tinggi.</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="portfolio section-padding">
  <div class="container">
    <div class="section-title text-center">
      <h2 class="fw-bold">Galeri Jasa Buang Puing</h2>
      <p class="text-muted">Lihat berbagai proyek pembersihan puing bangunan yang telah kami selesaikan dengan profesionalisme dan kepuasan pelanggan.</p>
    </div>
    ...
    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="/assets/img/puing/puing.jpg" class="img-fluid" alt="Pembersihan Puing Konstruksi">
          <div class="portfolio-overlay">
            <h4>Pembersihan Puing Konstruksi</h4>
            <a href="/assets/img/puing/puing.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="/assets/img/puing/puing3.jpg" class="img-fluid" alt="Jasa Angkut Limbah Bangunan">
          <div class="portfolio-overlay">
            <h4>Jasa Angkut Limbah Bangunan</h4>
            <a href="assets/img/puing/puing3.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="assets/img/puing/puing4.jpg" class="img-fluid" alt="Pembuangan Material Bekas">
          <div class="portfolio-overlay">
            <h4>Pembuangan Material Bekas</h4>
            <a href="assets/img/puing/puing4.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
    </div>
...
<section id="testimonials" class="testimonials section">
  ...
  <div class="container section-title" data-aos="fade-up">
    <h2>Testimoni Pelanggan Jasa Buang Puing Tukang Banten</h2>
    <p>Pelanggan kami berbagi pengalaman mereka setelah menggunakan layanan jasa buang puing dari Tukang Banten. Efisiensi, kebersihan, dan kepuasan pelanggan adalah prioritas kami.</p>
          ...
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                ...
                <span>"Layanan buang puing dari Tukang Banten sangat cepat dan bersih. Puing proyek saya langsung dibereskan tanpa hambatan!"</span>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>"Saya merenovasi rumah dan sangat terbantu dengan jasa buang puing ini. Lingkungan tetap bersih dan rapi!"</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>"Puing bangunan dari proyek saya ditangani dengan profesional oleh Tukang Banten. Sangat direkomendasikan!"</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div>
