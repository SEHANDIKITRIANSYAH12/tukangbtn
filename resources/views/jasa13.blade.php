...
<header id="header" class="header d-flex align-items-center fixed-top">
 ...
 <!-- Page Title -->
<div class="page-title dark-background" style="background-image: url(https://png.pngtree.com/thumb_back/fh260/background/20231010/pngtree-tropical-dark-green-leaf-texture-a-full-frame-view-of-lush-image_13601650.png);">
  <div class="container position-relative">
    <h1 class="sitename">Tukang<span class="highlight">Banten.</span></h1>
    <nav class="breadcrumbs">
      <ol>
        <li><a href="jasa1">JADIMITRA</a></li>
        <li class="current">JASA TUKANG LANDSCAPE TAMAN PROFESIONAL</li>
      </ol>
    </nav>
  </div>
</div><!-- End Page Title -->
  ...
  <div class="container">
    <div class="row position-relative">
      <div class="col-lg-7 about-img" data-aos="zoom-out" data-aos-delay="200">
        <img src="/assets/img/taman/taman3.jpg" alt="Gambar Jasa Landscape Taman">
      </div>
  ...
  <div class="container">
    <div class="row justify-content-around gy-4">
      ...
      <div id="carouselExample" class="carousel slide col-lg-6" data-bs-ride="carousel" data-aos="fade-up" data-aos-delay="100">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="/assets/img/taman/taman2.jpg" class="d-block w-100" alt="Jasa Landscape Taman">
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
        <h3>Jasa Pembuatan Landscape Taman Profesional</h3>
        <p>Kami menawarkan layanan pembuatan landscape taman dengan desain estetis dan material berkualitas tinggi untuk menciptakan taman impian Anda.</p>

        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="300">
          <i class="fas fa-tree flex-shrink-0"></i>
          <div>
            <h4><a href="" class="stretched-link">Desain Taman</a></h4>
            <p>Membantu merancang taman sesuai keinginan dengan konsep yang menarik dan fungsional.</p>
          </div>
        </div>

        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="400">
          <i class="fas fa-seedling flex-shrink-0"></i>
          <div>
            <h4><a href="" class="stretched-link">Penanaman Tanaman</a></h4>
            <p>Memilih dan menanam tanaman yang cocok untuk menciptakan suasana hijau dan asri.</p>
          </div>
        </div>

        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="500">
          <i class="fas fa-water flex-shrink-0"></i>
          <div>
            <h4><a href="" class="stretched-link">Sistem Irigasi</a></h4>
            <p>Instalasi sistem penyiraman otomatis agar taman tetap segar dan terawat.</p>
          </div>
        </div>
        ...
        <div class="icon-box d-flex position-relative" data-aos="fade-up" data-aos-delay="600">
          ...
          <div>
            <h4><a href="" class="stretched-link">Pembangunan Fasilitas</a></h4>
            <p>Pembuatan elemen tambahan seperti gazebo, jalan setapak, dan kolam air untuk mempercantik taman.</p>
          </div>
        </div>
      </div>
    </div>
...
<section class="portfolio section-padding">
  <div class="container">
    <div class="section-title text-center">
      <h2 class="fw-bold">Galeri Jasa Landscape Taman</h2>
      <p class="text-muted">Lihat berbagai proyek pembuatan landscape taman yang telah kami selesaikan dengan desain yang indah dan fungsional.</p>
    </div>
    ...
    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="/assets/img/taman/taman2.jpg" class="img-fluid" alt="Taman Minimalis">
          <div class="portfolio-overlay">
            <h4>Taman Minimalis</h4>
            <a href="/assets/img/taman/taman2.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="/assets/img/taman/taman4.jpg" class="img-fluid" alt="Taman Tropis">
          <div class="portfolio-overlay">
            <h4>Taman Tropis</h4>
            <a href="/assets/img/taman/taman4.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-4 col-md-6 portfolio-item">
        <div class="portfolio-card">
          <img src="/assets/img/taman/taman3.jpg" class="img-fluid" alt="Desain Taman Modern">
          <div class="portfolio-overlay">
            <h4>Desain Taman Modern</h4>
            <a href="/assets/img/taman/taman3.jpg" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
          </div>
        </div>
      </div>
    </div>
...
<section id="testimonials" class="testimonials section">
  <div class="container section-title" data-aos="fade-up">
    <h2>Testimoni Pelanggan Jasa Landscape Taman</h2>
    <p>Pelanggan kami berbagi pengalaman mereka setelah menggunakan layanan desain dan pembuatan taman dari Tukang Banten. Keindahan, kenyamanan, dan kualitas adalah prioritas kami.</p>
  </div>
          ...
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                ...
                <span>"Taman rumah saya menjadi lebih asri dan nyaman setelah menggunakan layanan dari Tukang Banten. Hasilnya luar biasa!"</span>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>"Taman di halaman rumah saya kini lebih hijau dan estetik. Sangat puas dengan hasil kerja Tukang Banten!"</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div>
        ...
        <div class="swiper-slide">
          <div class="testimonial-wrap">
            <div class="testimonial-item">
              ...
              <p>
                <i class="bi bi-quote quote-icon-left"></i>
                <span>"Desain taman yang dibuat sangat profesional dan sesuai konsep yang saya inginkan. Sangat direkomendasikan!"</span>
                <i class="bi bi-quote quote-icon-right"></i>
              </p>
            </div>
          </div>
